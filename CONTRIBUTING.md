# Contributing to <debusine-action>
...
1. [Fork](https://github.com/qualcomm-linux/debusine-action/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qualcomm-linux/debusine-action.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/debusine-action.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/debusine-action/pulls) from your branch to `main`.
